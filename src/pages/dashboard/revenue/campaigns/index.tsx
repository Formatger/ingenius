...
const RevenueCampaignsPage = () => {
  ...
  const breadcrumbLinks = [
    ...
    { label: "Revenue", link: "/dashboard/revenue/campaigns" },
    {
      ...
      link: "/dashboard/revenue/campaigns",
      current: true,
    },
  ];
