...
const CampaignCard: React.FC<ProjectsCardProps> = ({ generateCard, creatorSavedData, createdDate }) => {
  if (!generateCard) return null;
  console.log(generateCard)
  console.log("CARD DATA",creatorSavedData)
  ...
  return (
    ...
    <div className='card-box-container' key={generateCard.id}> 
      <div className='drag-profile-info'>
         <img src={generateCard.creator?.profile_picture_url} alt="Creator" width={70} height={70} />
