...
const AddFieldModalCampaign: React.FC<AddFieldModalDealProps> = ({ isOpen, onClose, title, updateDealData }) => {
        ...
        <div className="modal-overlay" onClick={onClose}>
            ...
            Add a new field to your kanban board here
                    ...
                    <div className='column-center'>
                        <button className="app-button mt-4" type="submit" onClick={addDealStage}>
                            Save
                        </button>
                    </div>
                </div>
